    ...
    return (
        <div>
            ...
            <div data-aos="fade-up"  className="grid  py-11 grid-cols-1 lg:grid-cols-4">
                <div>
                    <h1 className="text-2xl lg:mt-20 font-bold text-center text-white">Welcome to Login page</h1>
                </div>
                    ...
                    <div className="">
                        <form onSubmit={handleLogin} className="w-80 md:w-96 lg:w-3/4 mx-auto">
                            ...
                            <div className="form-control">
                                ...
                                <label className="label">
                                    <a href="#" className="label-text-alt text-white font-bold link link-hover">Forgot password?</a>
                                </label>
                            </div>
                        ...
                        <p className="text-center text-white font-bold mt-5">New to Scan_f Academy. Please<Link className="text-blue-600 underline font-bold" to={'/register'}> Register</Link></p>
                    </div>
                </div>
                <div>
                    <div className='p-4 space-y-3 mb-6'>
                        <h2 className="text-2xl text-orange-500 font-bold">Login With</h2>
                        <button onClick={handleGoogleSignIn} className="btn btn-outline text-white w-full">
                            <FaGoogle></FaGoogle>
                            Login with Google
                        </button>
                        <button onClick={handleGithubSignIn} className="btn btn-outline text-white w-full">
                            <FaGithub></FaGithub>
                            Login with Github
                        </button>
                    </div>
